...
| RACK_TIMEOUT_SERVICE_TIMEOUT | Abort requests taking longer than the specified number of seconds to process. Defaults to 15, see `rack-timeout` [docs](https://github.com/heroku/rack-timeout#configuring) for other configuration options. |
